...
class Adapter(
    ...
    inner class ItemViewHolder(val binding: ListItemAnimeBinding): RecyclerView.ViewHolder(binding.root)
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        val imageUrl = item.images?.jpg?.image_url // Hier sollte imageUrl die URL oder der Pfad zur Datei sein
